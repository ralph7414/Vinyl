...
CREATE Table
  vinyl_status (`id` integer PRIMARY KEY, status VARCHAR(10))

SELECT * FROM vinyl_status

INSERT INTO vinyl_status (id, status)
VALUES
  (0, "下架"),
  (1, "上架"),
  (2, "預購"),
...
SELECT vinyl_gender.id ,vinyl_genre.genre,vinyl_gender.gender FROM vinyl_gender JOIN vinyl_genre ON vinyl_genre.id=vinyl_gender.genre_id;

update vinyl set shs_id = 39393939 where id = 212

update vinyl_img set shs_id = 39393939 where id = 212
